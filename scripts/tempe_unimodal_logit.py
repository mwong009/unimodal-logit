...
V0 = ASC_noinjury   
V1 = ASC_possinjury + 2 * log(lmda) - lmda - log(1*2)
V2 = ASC_nonincap   + 3 * log(lmda) - lmda - log(1*2*3)
V3 = ASC_incap      + 4 * log(lmda) - lmda - log(1*2*3*4)
V4 = ASC_fatal      + 5 * log(lmda) - lmda - log(1*2*3*4*5)
...
biogeme = bio.BIOGEME(database, logprob, userNotes="Unimodal logit, 80%data, V0=0,V1=ln(2)")
biogeme.modelName = 'm2_unimodallogit'
